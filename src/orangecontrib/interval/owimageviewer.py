...
from .pkg.orangecontrib.imageanalytics.utils.image_utils import extract_paths
from .pkg.orangecontrib.imageanalytics.widgets.utils.imagepreview import Preview
from .pkg.orangecontrib.imageanalytics.widgets.utils.thumbnailview import (
    IconView as _IconView,
)
from .pkg.orangecontrib.imageanalytics.widgets.utils.thumbnailview import IconViewDelegate
...
class OWImageViewer(OWWidget):
    name = "图像查看器(Image Viewer)"
    description = "显示图像的缩略图。"
