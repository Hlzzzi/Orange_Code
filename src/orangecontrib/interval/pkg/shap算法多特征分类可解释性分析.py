...
def shap_vaule(data, features, target, classnames, othernames, modeltype='xgboost', modetype='特征选择数',
    ...
    modeltypelist_CN = ['xgboost分类算法', 'LGBMC分类算法',  'CatBoost分类算法',
...
#
# path = r"D:\微信下载\WeChat Files\wxid_68hl91pn8bse22\FileStorage\File\2024-09\数据大表.xlsx"
#
# data = data_read(path)
# target = 'Litho'
...
# paixu,shaixuan = shap_vaule(data, features, target, classnames, othernames, modeltype='xgboost分类算法', select_number=10, cutoff=0.5,
#            nanlists=[-10000, -99999, -9999, -999.99, -999.25, -999, -1, 999, 999.25, 9999, 99999],
#            figtypes=figtypes, showtype='各类特征分析')
#
# print(paixu)
# print('---------------------------------')
# print(shaixuan)