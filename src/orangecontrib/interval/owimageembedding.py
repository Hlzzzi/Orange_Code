...
from .pkg.orangecontrib.imageanalytics.image_embedder import \
    MODELS as EMBEDDERS_INFO
from .pkg.orangecontrib.imageanalytics.image_embedder import ImageEmbedder
from .pkg.orangecontrib.imageanalytics.utils.image_utils import filter_image_attributes
...
class OWImageEmbedding(OWWidget, ConcurrentWidgetMixin):
    name = "图像嵌入(Image Embedding)"
    description = "通过深度神经网络进行图像嵌入。"
