...
class Widget(OWWidget):
    ...
    def onComboBoxIndexChangedSF(self, index):
        ...
        self.modeltype = selected_text
        print(f"当前选择modeltype是：{selected_text}", self.modeltype)
    ...
    def __init__(self):
        ...
        allmodeltypelist = ['逻辑回归分类算法', '轻量级梯度提升树分类算法', '随机森林分类算法', '决策树分类算法',
                            '梯度提升树分类算法', 'AdaBoost树分类算法', '外联树分类算法']

        self.comboBoxleftSF.addItems(allmodeltypelist)
        ...
        self.input5.setPlaceholderText('请输入整数,默认为10')
