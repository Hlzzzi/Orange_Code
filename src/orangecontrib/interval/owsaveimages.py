...
from .pkg.orangecontrib.imageanalytics.image_embedder import MODELS
from .pkg.orangecontrib.imageanalytics.utils.embedder_utils import ImageLoader
...
class OWSaveImages(OWWidget, ConcurrentWidgetMixin):
    name = "保存图像(Save Images)"
    description = "保存图像到文件夹中。"
