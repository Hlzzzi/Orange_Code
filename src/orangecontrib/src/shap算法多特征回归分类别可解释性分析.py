...
class Widget(OWWidget):
    ...
    name = "shap算法多特征回归分类别可解释性分析"
    description = "shap算法多特征回归分类别可解释性分析"
    ...
    def __init__(self):
        ...
        alist = ['xgboost回归算法', 'LGBM回归算法', 'CatBoost回归算法', '随机森林回归算法', '决策树回归算法',
        ...
        # 创建多选框['shap特征排序图', 'shap散点交会图', '分类别shap散点交会图', '瀑布图', '交互依赖图', '平均shap值的条形图',
        ...
        hbox333333.addWidget(self.checkBox11)
        hbox333333.addWidget(self.checkBox12)
