...
from Orange.widgets.widget import OWWidget, MultiInput, Output, Input
...
class OWDataTable(OWWidget):
    ...
    class Inputs:
        ...
        table_list = Input('TableList',list,auto_summary=False)
    ...
    def read_table_list(self,table_list):
        ...
        self.tabs.clear() # 清除选项卡
        for i,table in enumerate(table_list):
            self.insert_dataset(i,table)
    ...
    def commit(self):
        ...
        if view and view.model() is not None:
            ...
            # for SqlTables 如果table是SqlTable类型的
